...
＊Zeroアプリに登録したい連絡先が、「連絡先アプリ」に未登録ならば、まず、「連絡先アプリ」に登録してください。 （＊＊登録しても検索に表示されない、、、下に別途説明しています）
...
（＊＊登録しても検索に表示されない、、、） 連絡先アプリに新規登録直後は、Zeroアプリに反映されない場合があります。 画面最下部中央の「ホーム画面へ」を押して、もう一度、Zeroアプリを立ち上げてみてください。
