...
　　　連絡先を登録。
  　「連絡先アプリ」に登録している連絡先を検索します。
    ...
    「連絡先アプリ」に登録してない場合は、まず、「連絡先アプリ」に登録してください。
     ...
     上から順に、青・やや薄青・さらに薄青・うっすらと青　のどの表示タイプで登録かを選び、「登録」を押してください。
     青・やや薄青・さらに薄青　は、登録できるのは１つまで。
     うっすらと青は、数の制限なく登録でき、フリガナでソートして表示。
     
     登録できた連絡先をタップすれば、下から、番号の確認が出てきます。
     これを押さないと、発信されません。
     間違って、連絡先をタップした時も、キャンセル　を押せば、大丈夫。
